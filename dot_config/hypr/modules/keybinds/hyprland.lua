...
for i = 1, 10 do
    local key = i % 10
    local ws_target = "name:" .. workspace_names[i]

    hl.bind(mainMod .. " + " .. key, hl.dsp.focus({ workspace = ws_target }))
    hl.bind(mainMod .. " + SHIFT + " .. key, hl.dsp.window.move({ workspace = ws_target }))
end
